...
data = load_data('svhn_classification.json')
data_parabolic = load_data('svhn_classification_parabolic.json')
...
plt.title('SVHN classification metrics using different pooling methods', fontsize=16)
plt.tight_layout()
plt.savefig('svhn_classification.pdf', format="pdf", bbox_inches="tight")
plt.show()
